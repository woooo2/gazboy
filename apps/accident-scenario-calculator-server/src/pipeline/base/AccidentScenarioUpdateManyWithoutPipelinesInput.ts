...
@InputType()
class AccidentScenarioUpdateManyWithoutPipelinesInput {
...
export { AccidentScenarioUpdateManyWithoutPipelinesInput as AccidentScenarioUpdateManyWithoutPipelinesInput };
