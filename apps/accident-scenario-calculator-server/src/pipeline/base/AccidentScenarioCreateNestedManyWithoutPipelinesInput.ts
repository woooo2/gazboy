...
@InputType()
class AccidentScenarioCreateNestedManyWithoutPipelinesInput {
...
export { AccidentScenarioCreateNestedManyWithoutPipelinesInput as AccidentScenarioCreateNestedManyWithoutPipelinesInput };
